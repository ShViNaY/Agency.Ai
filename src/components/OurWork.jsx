...
const OurWork = () => {
  ...
  return (
    ...
    id = 'our-work' className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
        <Title title = 'Our Lastest Work' desc = 'From strategy to execution, we craft digital solutions that move your business forward.'></Title>
        ...
        <motion.div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-5xl">
          {
            workData.map((work, index)=>(
              ...
              key = {index} className='hover:scale-102 duration-500 transition-all cursor-pointer'>
                ...
                <h3 className='t ext-sm opacity-60 w-5/6'>{work.description}</h3>
